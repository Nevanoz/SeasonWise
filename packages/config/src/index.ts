...
export const CROP_TEMPLATES: Record<string, CropTemplate> = {
  rice: {
    ...
    phases: [
      { name: "Persiapan Lahan (Land Prep)", startDay: 1, endDay: 15, costPercent: 20, description: "Pengolahan tanah dan pembajakan sawah" },
      { name: "Penanaman & Pemupukan Awal", startDay: 16, endDay: 30, costPercent: 30, description: "Penyemaian bibit dan pemupukan dasar" },
      ...
      { name: "Panen & Pengeringan", startDay: 91, endDay: 120, costPercent: 25, description: "Pemotongan padi dan rontok bulir" },
    ],
  },
  corn: {
    cropType: "corn",
