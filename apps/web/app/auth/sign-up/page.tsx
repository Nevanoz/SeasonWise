  ...
  return (
    <div className="max-w-[1200px] mx-auto px-6 py-12 fade-in">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="flex flex-col gap-2">
          <label htmlFor="password" className="text-xs font-bold uppercase tracking-wider text-text-secondary">Kata Sandi Baru</label>
          <div className="flex border border-border rounded-lg overflow-hidden bg-background/25">
        ...
        >
          {status === 'submitting' ? 'Memproses...' : 'Daftar Akun'}
        </button>
      </form>
